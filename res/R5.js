        ...
        <Card style={styles.card}>
          <Card.Content>
            ...
            <Text style={styles.texto}>
              Te recomendamos el DIU. Según el modelo puede durar años. Deberás
              visitar un experto para poder usarlo y tener visitas regulares
              para revisar su estado. {"\n"}
            </Text>

            <Card.Cover
              style={styles.cardimg}
              source={require("../assets/ac6.png")}
            />
          </Card.Content>
          <TouchableOpacity
            onPress={() => {
