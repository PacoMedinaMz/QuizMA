            ...
            <View style={styles.info}>
                <Card style={styles.card}>
                    <Card.Content>
                        ...
                        <Text style={styles.texto}>Píldoras. Debes visitar un experto y el te recomendara 
                            unas píldoras anticonceptivas. El te explicara el uso, recomendaciones, entre 
